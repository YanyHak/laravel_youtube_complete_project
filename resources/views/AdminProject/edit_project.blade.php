...
<body>
    ...
    <div class="container justify-content-center mt-2 mb-5">
        ...
        <form action="{{route('admin.projects.update',$project->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
                <img src="/images/{{ $project->thumbnail }}" alt="thumbnail" width="100" height="100">
            </div>
            ...
            <div class="form-group m-2 p-2">
                ...
                <input class="form-control" type="text" name="github_link" placeholder="Project GiHub Title" value="{{ $project->github_link }}">
            </div>

            <div class="form-group m-2 p-2">
                <label for="project_video_link">Video Link</label>
                <input class="form-control" type="text" name="youtube_link" placeholder="Project Video Title" value="{{ $project->youtube_link}}">
            </div>
