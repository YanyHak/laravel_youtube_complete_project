    ...
    <div class="container justify-content-center mt-2 mb-5">
        ...
        <form action="{{ route('admin.skills.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group m-2 p-2">
                <label for="project_description">Skills Name</label>
                <input class="form-control" type="text" name="technology" placeholder="Technology">
              
            </div>
             <div class="form-group m-2 p-2">
                <label for="project_description">Skills Score</label>
            ...
            <button class="btn btn-success" type="submit" value="submit">Add Skills</button>
